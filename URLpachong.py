...
if __name__ == '__main__':
    html = get_data('https://maoyan.com/ajax/proxy/mmdb/comments/movie/1337700.json?utm_medium=organic&uuid'
                    '=5E0A9FA0EACA11EB90DCEF921382954BC7F9D9C2933647CCABF5853DB5CFE6A8&ci=1')
    print(html)
...
def save_to_txt():
    ...
    while start_time > end_time:
        url = 'http://m.maoyan.com/mmdb/comments/movie/1337700.json?_v_=yes&offset=0&startTime=' + start_time.replace(' ', '%20')
        html = None
        '''
...
#  参考博文https://www.cnblogs.com/mylovelulu/p/9511369.html